...
use Teknoo\Kubernetes\Collection\CronJobCollection;
 ...
 * @author      Marc Lough <http://maclof.com>
 *
 * @covers      \Teknoo\Kubernetes\Repository\CronJobRepository
 ...
 */
class CronJobRepositoryTest extends AbstractBaseTestCase
{
    protected function getRepository(): Repository
    {
        return new CronJobRepository(
            $this->getClientMock(),
        );
    }
