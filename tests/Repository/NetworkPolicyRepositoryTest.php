...
use Teknoo\Kubernetes\Collection\NetworkPolicyCollection;
 ...
 * @author      Marc Lough <http://maclof.com>
 *
 * @covers      \Teknoo\Kubernetes\Repository\NetworkPolicyRepository
 ...
 */
class NetworkPolicyRepositoryTest extends AbstractBaseTestCase
{
    protected function getRepository(): Repository
    {
        return new NetworkPolicyRepository(
            $this->getClientMock(),
        );
    }
    ...
    {
        return NetworkPolicyCollection::class;
    }
