 ...
 * @author      Marc Lough <http://maclof.com>
 *
 * @covers      \Teknoo\Kubernetes\Repository\SubnamespaceAnchorRepository
 ...
 */
class SubnamespaceAnchorRepositoryTest extends AbstractBaseTestCase
{
    protected function getRepository(): Repository
    {
        return new SubnamespaceAnchorRepository(
            $this->getClientMock(),
        );
    }
    ...
    {
        return SubnamespaceAnchorCollection::class;
    }
