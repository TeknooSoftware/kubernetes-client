...
use Teknoo\Kubernetes\Collection\ClusterRoleBindingCollection;
 ...
 * @author      Marc Lough <http://maclof.com>
 *
 * @covers      \Teknoo\Kubernetes\Repository\ClusterRoleBindingRepository
 ...
 */
class ClusterRoleBindingRepositoryTest extends AbstractBaseTestCase
{
    protected function getRepository(): Repository
    {
        return new ClusterRoleBindingRepository(
            $this->getClientMock(),
        );
    }
    ...
    {
        return ClusterRoleBindingCollection::class;
    }
